...
export const FIELD_ALIASES: Record<string, string[]> = {
  ...
  dataSource: ["data source", "datasource", "source", "provenance", "origin"],
  positionBasis: ["position basis", "positionbasis", "position", "gps basis", "accuracy basis"],
  mountingType: ["mounting type", "mounting", "type", "transformer type", "mount"],
