...
export const EVENT_META: Record<EventType, { label: string; tone: Tone }> = {
  ...
  RECOVERED_FOR_REPAIR: { label: "Recovered for repair", tone: "warning" },
  RECEIVED_AT_WORKSHOP: { label: "At workshop", tone: "info" },
  REPAIR_STARTED: { label: "Repair started", tone: "info" },
  REPAIRED: { label: "Repaired", tone: "success" },
  REPAIR_FAILED: { label: "Beyond repair", tone: "danger" },
